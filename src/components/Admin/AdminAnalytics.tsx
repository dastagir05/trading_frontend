  ...
  const fetchAnalyticsData = async () => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/admin/analytics?${params}`
      );
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center mt-1">
                {getGrowthIcon(12.5)}
                <span
                  className={`text-sm font-medium ml-1 ${getGrowthColor(12.5)}`}
                >
                  +12.5%
                </span>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center mt-1">
                {getGrowthIcon(8.7)}
                <span
                  className={`text-sm font-medium ml-1 ${getGrowthColor(8.7)}`}
                >
                  +8.7%
                </span>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center mt-1">
                {getGrowthIcon(15.2)}
                <span
                  className={`text-sm font-medium ml-1 ${getGrowthColor(15.2)}`}
                >
                  +15.2%
                </span>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center mt-1">
                {getGrowthIcon(-2.1)}
                <span
                  className={`text-sm font-medium ml-1 ${getGrowthColor(-2.1)}`}
                >
                  -2.1%
                </span>
