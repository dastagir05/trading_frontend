...
import adminApiService, { type AdminLog, type AdminActivitySummary } from '@/services/adminApi';
...
const AdminActivity: React.FC = () => {
  ...
  const fetchActivity = async () => {
    try {
      setIsLoading(true);
      const result = await adminApiService.getAdminLogs(session?.user?._id || '', {
        page: currentPage,
        limit: 20,
        ...filters
      });
  ...
  const fetchSummary = async () => {
    try {
      const result = await adminApiService.getAdminActivitySummary(session?.user?._id || '', 30);
      if (result.success) {
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{summary.failedActions}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{summary.highRiskActions}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{summary.suspiciousActions}</p>
              </div>
            </div>
          </div>
        </div>
